...
<div><div style="break-inside: avoid-page;"><tr style="font-size: 1.1em;"><td>一、Assistance Title</td></tr><div style="break-inside: avoid-page; "><div style="display: flex; text-indent: 2em; padding-top: 1em;">（一）指派專責會計人員</div><div style="display: flex; flex-direction: column; padding-left: 5em;"><div style="display: flex; text-indent: 2em;">為期本專業服務能順利完成，爰建議  貴公司應指派熟悉公司會計作業流程之人員，以作為與本事務所溝通協調及對內對外之窗口。</div></div></div></div><div style="break-inside: avoid-page; "><div style="display: flex; text-indent: 2em; padding-top: 1em;">（二）網路銀行申請</div><div style="display: flex; flex-direction: column; padding-left: 5em;"><div style="display: flex; text-indent: 2em;">為方便本事務所執行出納事務，故請 貴公司配合申請網路銀行，以利運作順暢。(請提供編輯與審核帳號各一組)</div></div></div><div style="break-inside: avoid-page; "><div style="display: flex; text-indent: 2em; padding-top: 1em;">（三）配合及時提供相關資訊</div><div style="display: flex; flex-direction: column; padding-left: 5em;"><div style="display: flex; text-indent: 2em;">為順利達成上述服務，委任人應提供相關之會計資訊、文件及憑證等，供受任人審閱，並答覆有關問題之詢問。委任人會計人員應對財會委外工作儘量協助，此項協助包括憑證蒐集、對帳、提供有關文件資料、相關問題詢問等；至於其具體配合事項，將由受任人之服務人員於工作開始前，提供應備資料清單，商請委任人有關人員惠予配合。</div></div></div></div>
""")
