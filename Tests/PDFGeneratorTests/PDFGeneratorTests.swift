...
<div><tr style="font-size: 1.1em;"><td>一、Assistance Title</td></tr><div style="break-inside: avoid-page; "><div style="display: flex; text-indent: 2em; padding-top: 1em;">（一）指派專責會計人員</div><div style="display: flex; flex-direction: column; padding-left: 5em;"><div style="display: flex; text-indent: 2em;">為期本專業服務能順利完成，爰建議  貴公司應指派熟悉公司會計作業流程之人員，以作為與本事務所溝通協調及對內對外之窗口。</div></div></div><div style="break-inside: avoid-page; "><div style="display: flex; text-indent: 2em; padding-top: 1em;">（二）網路銀行申請</div><div style="display: flex; flex-direction: column; padding-left: 5em;"><div style="display: flex; text-indent: 2em;">為方便本事務所執行出納事務，故請 貴公司配合申請網路銀行，以利運作順暢。(請提供編輯與審核帳號各一組)</div></div></div><div style="break-inside: avoid-page; "><div style="display: flex; text-indent: 2em; padding-top: 1em;">（三）配合及時提供相關資訊</div><div style="display: flex; flex-direction: column; padding-left: 5em;"><div style="display: flex; text-indent: 2em;">為順利達成上述服務，委任人應提供相關之會計資訊、文件及憑證等，供受任人審閱，並答覆有關問題之詢問。委任人會計人員應對財會委外工作儘量協助，此項協助包括憑證蒐集、對帳、提供有關文件資料、相關問題詢問等；至於其具體配合事項，將由受任人之服務人員於工作開始前，提供應備資料清單，商請委任人有關人員惠予配合。</div></div></div></div>
""")
...
@Test func createNote(){
    ...
    #expect(note.render() == """
    <table><tr style="break-inside: avoid-page;"><td style="width: 3.8rem; vertical-align: top; font-size: 0.8rem;">註一：</td><td><div><div style="font-size: 0.8rem;">報價依照年度營收狀況及資產總額狀況評估，若有巨額變動時，將另與 貴公司民國112年以後依照附表一、專屬全家人健康事業(股) 會計帳務及稅務申報處理作業級距表討論報價金額。簽證公費請於當年底時支付半數，另外半數請於交付報告時支付；財會委外會計帳務暨稅務處申報理作業費用一年以十四個月計算，並請於次月底前支付前一個月之公費。合約執行期間不得低於二年，解除合約須提前三個月告知。</div></div></td></tr><tr style="break-inside: avoid-page;"><td style="width: 3.8rem; vertical-align: top; font-size: 0.8rem;">註二：</td><td><div><div style="font-size: 0.8rem;">出納事務處理作業內容包含：</div><div style="font-size: 0.8rem;">A.國內轉帳30 筆；每加⼀筆多50 元。</div><div style="font-size: 0.8rem;">B.國外轉帳10 筆；每加⼀筆多100 元。</div><div style="font-size: 0.8rem;">C.⼀次薪資轉帳。</div></div></td></tr><tr style="break-inside: avoid-page;"><td style="width: 3.8rem; vertical-align: top; font-size: 0.8rem;">註三：</td><td><div><div style="font-size: 0.8rem;">薪資人力支援處理作業500元/人/月；基本收費3,000/月。</div></div></td></tr></table>
    """)
